...
# LYNX_DIR = os.path.normpath(os.path.join(HARMONY_DIR, '..', '..', 'lynx'))
# TEMPLATE_DIR = os.path.normpath(os.path.join(LYNX_DIR, 'explorer', 'homepage'))
# TEMPLATE_DEVTOOL_DIR = os.path.normpath(os.path.join(LYNX_DIR, 'devtool', 'lynx_devtool', 'resources','devtool-switch'))
